...
var referencePanel = new ui.ReferencePanel({
      'defaultValue' : [],
      ...
      'onLoadVersions': function(onLoad) {
        $.ajax({
          ...
          url: "https://public-api.wordpress.com/rest/v1.1/versions",
          success: function(data) {
            onLoad(null, data.versions, data.current_version);
          }
        });
      },
    ...
    versionSelector = new ui.OptionSelector($('#versions'), {
      tabIndex: '2',
      values: ['1', '1.1'],
