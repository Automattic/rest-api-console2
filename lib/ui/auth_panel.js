...
AuthPanel.prototype.checkProxyAuth = function() {
  this.node.addClass(this.options.loadingClass);
  this.options.onCheckToken(this, this.onCheck.bind(this));
  this.authTimer = setTimeout(this.abortAuth.bind(this), 1000);
};
...
AuthPanel.prototype.getAuthenticationUri = function() {
  ...
  return "https://wordpress.com/wp-login.php?" + Component.$.param({
    'redirect_to' : this.getRedirectUri()
  });
  
  // return "https://public-api.wordpress.com/oauth2/authorize?" + Component.$.param({
...
AuthPanel.prototype.signOut = function() {
  window.location = "https://wordpress.com/wp-login.php?" + Component.$.param({
    'action' : 'logout',
    'redirect_to' : this.getRedirectUri()
  });
};
